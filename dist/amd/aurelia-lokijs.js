define(["require", "exports", "./loki-provider", "./loki-settings", "./adapters/loki-indexed-db-adapter", "./loki-provider", "./loki-settings", "./decorators", "./resolvers"], function (require, exports, loki_provider_1, loki_settings_1, loki_indexed_db_adapter_1, loki_provider_2, loki_settings_2, decorators_1, resolvers_1) {
    "use strict";
    function __export(m) {
